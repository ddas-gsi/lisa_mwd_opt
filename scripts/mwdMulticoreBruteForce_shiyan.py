...
def worker_function(params):
    ...
    root_command = ["root", "-l", "-q", "-b", f"mwd_shiyan.C({channelID},{smoothing_L},{MWD_length},{MWD_trace_start},{MWD_trace_stop},{MWD_amp_start},{MWD_amp_stop},{MWD_baseline_start},{MWD_baseline_stop},{Sampling},{Decaytime_ch},{FIT_RANGE_PAR})"]
...
def mwd_multicore():
    ...
    for params in param_combinations:
        ...
        if (smoothing_L<MWD_length) and ((smoothing_L+MWD_length)<(MWD_trace_stop-MWD_trace_start)) and (MWD_trace_start<MWD_trace_stop) and (MWD_trace_start>=0):
            ...
            # MWD_trace_start = 0.0  # since the MWD trace has shifted to 0
